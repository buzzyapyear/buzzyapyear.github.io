...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'cydotcom.contexts.navSelect',
    'cydotcom.contexts.imagesURL',
    'cydotcom.contexts.mobileSniff',
    'cydotcom.contexts.getDate',
)
