...
export const DIFFICULTY = Object.freeze({
  ...
  medium: {
    ...
    aiShootAccuracy: 0.55,
    aiHesitationMs: 500,
    aiPassErrorChance: 0.17,
    keeperReaction: 0.14,
    keeperCoverage: 0.65,
    keeperReactionDelayMs: 220,
    bodyChallengeProbability: 0.13,
    tackleRangeBonus: 10,
    aiPickupCooldownMs: 350,
  },
  hard: {
    label: 'Hard',
    aiSpeedMultiplier: 0.90,
    aiShootAccuracy: 0.70,
    aiHesitationMs: 300,
    aiPassErrorChance: 0.10,
    keeperReaction: 0.19,
    keeperCoverage: 0.80,
    keeperReactionDelayMs: 120,
    bodyChallengeProbability: 0.20,
    tackleRangeBonus: 3,
    aiPickupCooldownMs: 200,
  },
});
